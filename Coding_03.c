...
int main() {
    ...
    printf("2. x < z\n");
    printf("   Sol: %d < %d คือ %d\n", x, z, expression_2);
    printf("   result: %s\n\n", expression_2 ? "True" : "False"); // แสดงเป็น True/False

    // ข้อ 3
    int expression_3 = (x == z);
    printf("3. x == z\n");
    printf("   Sol: %d == %d คือ %d\n", x, z, expression_3);
    printf("   result: %s\n\n", expression_3 ? "True" : "False"); // แสดงเป็น True/False

    // ข้อ 4
    int expression_4 = (x != y);
    printf("4. x != y\n");
    printf("   Sol: %d != %d คือ %d\n", x, y, expression_4);
    printf("   result: %s\n\n", expression_4 ? "True" : "False"); // แสดงเป็น True/False

    // ข้อ 5: !(2*5 >= y) || (5 != (5/3))
    // ใน C: ! คือ NOT, || คือ OR
    // 5/3 ใน C จะเป็นการหารจำนวนเต็ม ผลลัพธ์คือ 1 (ไม่ใช่ 1.xxxxxx)
    ...
    printf("   Sol: \n");
    printf("     : (2*5 >= y) คือ (10 >= %d) ซึ่งคือ %d\n", y, part1_expr5);
    printf("     : คือ !%d ซึ่งคือ %d\n", part1_expr5, !part1_expr5);
    printf("     : (5 != (5/3)) คือ (5 != %d) ซึ่งคือ %d (เนื่องจาก 5/3 ใน C คือ 1)\n", (5/3), part2_expr5);
    printf("     : %d || %d คือ %d\n", !part1_expr5, part2_expr5, expression_5);
    printf("   result: %s\n\n", expression_5 ? "True" : "False"); // แสดงเป็น True/False
    ...
    printf("   result: %s\n\n", expression_6 ? "True" : "False"); // แสดงเป็น True/False
    ...
    printf("   result: %s\n\n", expression_7 ? "True" : "False"); // แสดงเป็น True/False
    ...
    printf("   Sol: \n");
    printf("     : (x %% 2 == 0) คือ (%d %% 2 == 0) ซึ่งคือ %d (12 หาร 2 ลงตัว คือ True)\n", x, part1_expr8);
    printf("     : (y %% 2 == 1) คือ (%d %% 2 == 1) ซึ่งคือ %d (7 หาร 2 เหลือเศษ 1 คือ True)\n", y, part2_expr8);
    printf("     : %d || %d คือ %d\n", part1_expr8, part2_expr8, expression_8);
    printf("   result: %s\n\n", expression_8 ? "True" : "False"); // แสดงเป็น True/False
    ...
    printf("9. (x > y) && (z < y)\n");
    printf("   Sol: \n");
    printf("     : (x > y) คือ (%d > %d) ซึ่งคือ %d (12 > 7 คือ True)\n", x, y, part1_expr9);
    printf("     : (z < y) คือ (%d < %d) ซึ่งคือ %d (12 < 7 คือ False)\n", z, y, part2_expr9);
    printf("     : %d && %d คือ %d\n", part1_expr9, part2_expr9, expression_9);
    printf("   result: %s\n\n", expression_9 ? "True" : "False"); // แสดงเป็น True/False
